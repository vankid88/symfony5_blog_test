...
class __TwigTemplate_2e2bce8606d35dae89095a6ee7eadaa250514c95dc63e8d1897e206573165c13 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("layout/default.html.twig", "product/show.html.twig", 1);
...
\t\t\t\t\t<td>";
        // line 32
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 32, $this->source); })()), "category", [], "any", false, false, false, 32), "name", [], "any", false, false, false, 32), "html", null, true);
        echo "</td>
\t\t\t\t</tr>
\t\t\t</tbody>
\t\t</table>
...
\t\t<a class=\"btn btn-sm btn-primary\" href=\"";
        // line 38
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 38, $this->source); })()), "id", [], "any", false, false, false, 38)]), "html", null, true);
        echo "\">Edit</a>
\t</div>
";
    ...
    {
        return array (  176 => 38,  172 => 37,  164 => 32,  157 => 28,  150 => 24,  143 => 20,  136 => 16,  128 => 10,  118 => 9,  99 => 7,  80 => 5,  61 => 3,  38 => 1,);
    }
...
{% block pageTitle %}Show product {% endblock %}

{% block title  %}Show{% endblock %}

{% block breadcrumb %}Product{% endblock %}
...
\t\t<a class=\"btn btn-sm btn-primary\" href=\"{{ path('product_edit', {'id': product.id}) }}\">Edit</a>
\t</div>
{% endblock %}", "product/show.html.twig", "C:\\nginx\\www\\symfony5\\blog_dev\\templates\\product\\show.html.twig");
    }
}
