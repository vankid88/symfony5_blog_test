...
class __TwigTemplate_89f54129a0d02ba78be5c7e5362b0355bccab4d6872c22d1846fd0c2c3bc62bb extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("layout/default.html.twig", "category/index.html.twig", 1);
...
";
    ...
    {
        return array (  192 => 41,  183 => 37,  174 => 33,  170 => 32,  165 => 30,  161 => 29,  157 => 28,  154 => 27,  149 => 26,  133 => 13,  128 => 10,  118 => 9,  99 => 7,  80 => 5,  61 => 3,  38 => 1,);
    }
...
\t<p> 
\t\t<a class=\"btn btn-sm btn-primary\" href=\"{{ path('category_new') }}\">Create new</a>
\t</p>
    ...
    <table class=\"table table-bordered\">
        ...
        {% for category in categories %}
            <tr>
                ...
                <td>
                    <a class=\"btn btn-sm btn-primary\" href=\"{{ path('category_show', {'id': category.id}) }}\"><i class=\"fa fa-eye\" aria-hidden=\"true\"></i> Show</a>
                    <a class=\"btn btn-sm btn-info\" href=\"{{ path('category_edit', {'id': category.id}) }}\"><i class=\"fa fa-pencil-square\" aria-hidden=\"true\"></i> Edit</a>
                </td>
            </tr>
        {% else %}
            <tr>
...
\t
{% endblock %}", "category/index.html.twig", "C:\\nginx\\www\\symfony5\\blog_dev\\templates\\category\\index.html.twig");
    }
}
