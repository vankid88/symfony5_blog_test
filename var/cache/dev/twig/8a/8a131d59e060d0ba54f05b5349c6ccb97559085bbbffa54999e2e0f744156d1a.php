...
class __TwigTemplate_9dd63aace736277fb18f19f79cb7bff7d264b420a817626dede886bf16d53e1a extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"form-group\">
        ";
        // line 7
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 7, $this->source); })()), "description", [], "any", false, false, false, 7), 'row', ["attr" => ["class" => "form-control"]]);
        echo "
    </div>
...
";
    ...
    {
        return array (  69 => 12,  65 => 11,  61 => 10,  55 => 7,  48 => 3,  43 => 1,);
    }
    ...
    <a class=\"btn btn-sm btn-default\" href=\"{{ path('category_index') }}\">Back to list</a>
    <button class=\"btn btn-sm btn-primary\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}", "category/_form.html.twig", "C:\\nginx\\www\\symfony5\\blog_dev\\templates\\category\\_form.html.twig");
    }
}
